...
| `app/preview/homepage/[branchSlug]/page.tsx` | **1,559** | (변경 없음) | 5/10 cowork 검증 시 캐리오버 오류 수정 (1,558→1,559) |
...
| 어드민 caller — 3 위치 | `booking-page.tsx:398, 424, 436` | ✅ (모바일/데스크톱/풀스크린) |
